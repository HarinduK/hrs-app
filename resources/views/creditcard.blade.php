...
@section('head')
    ...
    <script type="text/javascript" src="{{ URL::asset('js/creditcard.js') }}"></script>
@endsection
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Add CreditCard Details</h6>
                            <form id="formHotel" class="needs-validation" novalidate="">
                                {{ csrf_field() }}
                                <div class="form-row">
                                    <div class="col-md-10 mb-3">
                                        <label for="validationCustom01">card number</label>
                                        <input name="card_number" type="number" class="form-control" id="validationCustom01"
                                ...
                                <div class="form-row">
                                    <div class="col-md-10 mb-3">
                                        ...
                                        <input name="cvv" type="text" class="form-control" id="validationCustom03"
